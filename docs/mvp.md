...
- **Redis dedupe** — dispatch + result integrated; **Day 109** worker execution design — **[worker-execution-idempotency.md](design/worker-execution-idempotency.md)** (not implemented)
