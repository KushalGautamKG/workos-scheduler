...
- **Worker throughput benchmark** — **`benchmark_worker_throughput.sh`** (Day 91) measures dispatch → worker → result on Kafka; complements scheduler benchmarks; **end-to-end completion** throughput still future work
