...
- **Redis dedupe** — dispatch + result integrated; **Day 110** Go **`IdempotencyStore`** / in-memory store (handler not wired; Redis next) — **[worker-execution-idempotency.md](design/worker-execution-idempotency.md)**
